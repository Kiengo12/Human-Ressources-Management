...
<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="/entreprise" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="label" for="nom">Nom de l'entreprise</label>
                        <input type="text" class="form-control" name="nom_entreprise" id="nom" placeholder="nom" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <label class="label" for="type_entreprise">Forme juridique de l'entreprise</label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="label" for="annee_experience">Nombre d'annees d'existence</label>
                        <input type="number" class="form-control" name="annee_experience" id="annee_experience" placeholder="Annee d'existence" required>
                    </div>
                </div>
                <div class="col-md-6"> 
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="label" for="domaine_expertise">Domaine d'action</label>
                        <input type="text" class="form-control" name="domaine_expertise" id="domaine_expertise" placeholder="Domaine d'action" required>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="label" for="resume">Breve description de votre entreprise</label>
